        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 mx-3 md:mx-12 my-12 text-gray-600" >
            ...
            <div className="shadow-lg rounded-lg py-5">
                ...
                <div className="flex items-center justify-start">
                    <img className="h-8 w-8 ml-3 rounded-full  shadow-slate-900" src={img} alt="" />
                ...
                <div>
                    ...
                    <h2 className="bg-slate-200 mx-1 rounded-md font-semibold">
                        Customer Service
                    </h2>
                </div>
            ...
            <div className="shadow-lg rounded-lg relative h-screen">
                ...
                <div className="flex justify-around ">
                    <p className="bg-zinc-300 px-2 rounded-b-lg py-1">Text from app</p>
            ...
            <div className="shadow-lg rounded-lg">
                ...
                <div className="flex justify-around ">
                    <p>Text from app</p>
                    <p className="bg-zinc-300 px-2 rounded-b-lg py-1">Customer Service</p>
                </div>
