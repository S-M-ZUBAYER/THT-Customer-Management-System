...
function Translator() {
    ...
    return (
        <div>
            <h1 className="font-bold text-2xl underline  text-yellow-600">Single language Translator System</h1>
            ...
            <div className="App md:my-24 flex justify-center items-center bg-yellow-300">
                ...
                <div className=" ">
                    ...
                    <div className=' bg-yellow-300 md:flex rounded-lg p-5'>
                            ...
                            <div className="border-2 border-slate-600 md:ml-2 sm:rounded-b-lg md:rounded-b-none md:rounded-bl-lg mb-2 mr-2 md:mr-0">
                                <div className="flex justify-between items-center ml-2">
                                    ...
                                    <div>
                                        ...
                                        <select name='language' type="boolean" placeholder='Sold Status' className="select select-bordered w-full px-2 py-2 bg-yellow-300 font-semibold rounded-lg  focus:outline-green-500  text-gray-900">
                        ...
                        <div>
                            <div ref={divRef11} placeholder="Translation" id="to-text" className="border-2 overflow-scroll text-start text-black bg-white border-slate-600 rounded-t-lg md:rounded-none md:rounded-tr-lg p-2 mt-2 mr-2 h-44  w-72 md:w-64 lg:w-72 block">
                                {
                                ...
                                <div className="flex justify-between items-center ml-2 ">
                                    ...
                                    <div className="form-control" onChange={handleTargetLan2}>
                                        <div className="input-group" id='lan'>
                                            <select name='language' type="boolean" placeholder='Sold Status' className="select select-bordered w-full px-3 py-2 rounded-md focus:outline-green-500 bg-yellow-300 font-semibold text-gray-900">
          ...
          <button className="my-5 bg-white w-full py-1 rounded-lg font-semibold" onClick={handleToTranslate} >Text Translate</button>
            ...
            <h1 className="font-bold text-2xl underline text-lime-500">Multiple language Translator System</h1>
