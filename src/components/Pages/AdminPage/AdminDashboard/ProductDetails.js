                            ...
                            <div className="container">
                                ...
                                <div className="grid grid-cols-3 gap-4">
                                    {((Product?.allVideos).split(",")).map((video, index) => (
                                        <div
                                            key={index}
                                            onClick={() => handleVideoClick(`https://grozziie.zjweiting.com:8033/tht/${productCategory==="mallProduct"?"mallProductImages":"eventProductImages"}/${video}`)}
                                            className="relative cursor-pointer"
                                        >
                                            <video
                                                src={`https://grozziie.zjweiting.com:8033/tht/${productCategory==="mallProduct"?"mallProductImages":"eventProductImages"}/${video}`}
                                                alt={`Video ${index + 1}`}
