...
const ErrorPage = () => {
    ...
    return (
        <div>
            <section className="flex items-center h-full sm:p-16 dark:bg-gray-900 text-slate-300 dark:text-gray-100 bg-gradient-to-t from-black via-slate-800 to-gray-900">
