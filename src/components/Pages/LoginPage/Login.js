...
const Login = () => {
  ...
  const handleSubmit = (event) => {
    ...
    fetch('http://localhost:2000/tht/login', {
      method: 'POST',
      headers: {
  ...
  const handleToResetPassword = () => {
    ...
    fetch('http://localhost:2000/tht/reset-password', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
      ...
      <div className="shadow-lg  my-12 py-10 px-12" >
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="">
            ...
            <div className="text-start mb-8" style={{ maxHeight: '300px', overflowY: 'scroll', border: '1px solid #ccc' }}>
