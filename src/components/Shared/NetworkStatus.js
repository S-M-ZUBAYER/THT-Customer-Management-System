        ...
        <>
            ...
            <div className="flex justify-around">
                <div className="flex items-center gap-1">
                    ...
                    {userInfo?.image ? (
                        <img
                            className={`rounded-full h-8 w-8 border-2 ${isOnline ? "border-green-700" : "border-red-700"}`}
                            src={userInfo.image}
                            alt="User Avatar"
                        />
                    ) : (
                    ...
                    <p className={`${isOnline ? "text-green-700" : "text-red-700"} font-semibold`}>{isOnline ? "Online" : "Offline"}</p>
                </div>
            </div>
